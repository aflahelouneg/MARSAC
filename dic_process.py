...
def suction_dic(data_directory_path, pydic_methods, SAVE_VIDEO_FRAMES = False
    ...
    pydic = imp.load_source('pydic_methods', pydic_methods) # URL to import pydic.py
